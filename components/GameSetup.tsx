    ...
    <div className="min-h-[100dvh] w-full bg-slate-900 flex flex-col p-4 overflow-y-auto">
      <div className="max-w-3xl w-full bg-slate-800 border border-slate-700 rounded-3xl p-6 md:p-10 shadow-2xl m-auto">
        <div className="text-center mb-6 md:mb-10">
          <h1 className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-brand to-emerald-400 mb-2 md:mb-4 brand-font">
            TEAM DUEL
          </h1>
        ...
        <div className="mb-8 md:mb-10">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6">
            <button 
              ...
              className={`flex-1 p-4 md:p-6 rounded-xl border-2 flex flex-col items-center gap-2 md:gap-3 transition-all ${teamCount === 2 ? 'bg-brand border-brand shadow-lg scale-[1.02] md:scale-105' : 'bg-slate-700 border-slate-600 hover:bg-slate-600'}`}
            >
            ...
            <button 
              ...
              className={`flex-1 p-4 md:p-6 rounded-xl border-2 flex flex-col items-center gap-2 md:gap-3 transition-all ${teamCount === 4 ? 'bg-brand border-brand shadow-lg scale-[1.02] md:scale-105' : 'bg-slate-700 border-slate-600 hover:bg-slate-600'}`}
            >
            ...
            {Array.from({ length: teamCount }).map((_, i) => (
              <div key={i} className="flex flex-col">
                ...
                <input
                  ...
                  className="bg-slate-900 border-2 border-slate-700 rounded-lg p-3 md:p-4 text-lg md:text-xl text-white focus:border-brand focus:outline-none transition-colors"
